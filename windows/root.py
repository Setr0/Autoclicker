...
root.config(bg='#292D3E')
root.iconbitmap('icon/favicon.ico')

titleApp = Label(root, text='Autoclicker', font=('Helvetica', 30), fg=('white'), background='#292D3E')
titleApp.place(x=350, y=60)

startClickLabel = Label(root, text="Start clicking button", fg="white", background='#292D3E', font=("Helvetica", 15))
...
stopClickLabel = Label(root, text="Stop clicking button", fg="white", background='#292D3E', font=("Helvetica", 15))
...
clickLabel = Label(root, text="Number of clicks", fg="white", background='#292D3E', font=("Helvetica", 15))
clickLabel.place(x=125, y=380)
clickEntry = Entry(background='#292D3E', highlightcolor="white", highlightbackground="white", highlightthickness=1, disabledbackground='#2f3447', disabledforeground="white", fg='white', font=('Helvetica', 20), insertbackground='white')
